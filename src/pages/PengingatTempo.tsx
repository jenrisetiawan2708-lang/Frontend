        ...
        <section className="bg-blue-600 rounded-2xl px-8 py-6 flex flex-col lg:flex-row justify-between items-center text-white shadow-md gap-5">
          <div className="flex gap-5 items-center">
            <div className="bg-white/10 rounded-xl p-3 shrink-0">
              <svg viewBox="0 0 64 64" fill="none" className="w-10 h-10 text-white"><path d="M32 8C18.7 8 8 18.7 8 32c0 4.2 1.1 8.1 3.1 11.5L8 56l12.8-3.1C24 54.9 27.9 56 32 56c13.3 0 24-10.7 24-24S45.3 8 32 8Z" stroke="currentColor" strokeWidth="4" strokeLinejoin="round"/></svg>
            </div>
            <div>
